import { convertToExpression } from '../src/expressions/condition/convert-condition-expression'
...
describe('ConditionExpression', () => {
  it('eq() - should return expected expression', () => {
    const expression = convertToExpression('test', eq('name', 'declan'))
  ...
  it('notEq() - should return expected expression', () => {
    const expression = convertToExpression('test', notEq('name', 'declan'))
    expect(expression.expression).toEqual('#test-0 <> :test-1')
    expect(expression.expressionAttributeNames).toEqual({
      '#test-0': 'name'
    })
  ...
  it('gt() - should return expected expression', () => {
    const expression = convertToExpression('test', gt('age', 25))
    expect(expression.expression).toEqual('#test-0 > :test-1')
    expect(expression.expressionAttributeNames).toEqual({
      '#test-0': 'age'
    })
  ...
  it('gte() - should return expected expression', () => {
    const expression = convertToExpression('test', gte('age', 25))
    expect(expression.expression).toEqual('#test-0 >= :test-1')
    expect(expression.expressionAttributeNames).toEqual({
      '#test-0': 'age'
    })
  ...
  it('lt() - should return expected expression', () => {
    const expression = convertToExpression('test', lt('age', 25))
    expect(expression.expression).toEqual('#test-0 < :test-1')
    expect(expression.expressionAttributeNames).toEqual({
      '#test-0': 'age'
    })
  ...
  it('lte() - should return expected expression', () => {
    const expression = convertToExpression('test', lte('age', 25))
    expect(expression.expression).toEqual('#test-0 <= :test-1')
    expect(expression.expressionAttributeNames).toEqual({
      '#test-0': 'age'
    })
  ...
  it('beginsWith() - should return expected expression', () => {
    const expression = convertToExpression('test', beginsWith('name', 'dec'))
  ...
  it('between() - should return expected expression', () => {
    const expression = convertToExpression('test', between('year', '2018', '2020'))
  ...
  it('exists() - should return expected expression', () => {
    const expression = convertToExpression('test', exists('name'))
  ...
  it('notExists() - should return expected expression', () => {
    const expression = convertToExpression('test', notExists('name'))
  ...
  it('contains() - should return expected expression', () => {
    const expression = convertToExpression('test', contains('year', '2018'))
  ...
  it('anyOf() - should return expected expression', () => {
    const expression = convertToExpression('test', anyOf('year', ['2018', '2019', '2020']))
  ...
  it('type() - should return expected expression', () => {
    const expression = convertToExpression('test', type('year', 'S'))
  ...
  it('size() - should return expected expression', () => {
    const expression = convertToExpression('test', size('year'))
  ...
  it('and() - should return expected expression', () => {
    const expression = convertToExpression('test', eq('name', 'declan'), and(), eq('age', 26))
  ...
  it('or() - should return expected expression', () => {
    const expression = convertToExpression('test', eq('name', 'declan'), or(), eq('age', 26))
  ...
  it('not() - should return expected expression', () => {
    const expression = convertToExpression('test', not(eq('name', 'declan')))
  ...
  it('group() - should return expected expression', () => {
    const expression = convertToExpression('test', group(eq('name', 'declan'), or(), eq('age', 26)))
    expect(expression.expression).toEqual('(#test-0 = :test-1 or #test-2 = :test-3)')
    expect(expression.expressionAttributeNames).toEqual({
      '#test-0': 'name',
      '#test-2': 'age'
